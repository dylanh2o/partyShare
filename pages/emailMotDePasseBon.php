<?php
/*
  Page     : emailMotDePasseBon.php
  Auteur   : Carluccio Dylan
  Fonction : Page de configuration de l'email pour valider le changement de mot de passe
 */
...
$message = 'Bonjour ' . $prenom . ',<br/>Ton mot de passe à bien été modifié le ' . $date . '<br/> Merci de votre confiance.<br/>L\'équipe de Party Share';
